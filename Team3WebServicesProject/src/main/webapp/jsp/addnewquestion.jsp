...
<body>
    ...
    <div class="signUp">
        ...
        <form method="post" action="/rest/addquestion/addnewquestion">
            <div class="signUp">
                <div class="main">
                    <div class="container">
                        <div class="sign-up-content" style="text-align: center;">
                            <label for="kysymys">Syötä kysymys</label> <br>
                            <textarea rows="5" cols="80" name='kysymys' style="width:24rem; margin-top: 10px;"></textarea><br><br>
                            <button type="submit" value="Tallenna" class="button">Tallenna</button>
                        </div>
                    </div>
