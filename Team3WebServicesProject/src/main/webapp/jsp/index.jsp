...
<body> 
    ...
    <div class="row">
        <div class="intro">
            ...
            <p class="introText">Tervetuloa vaali sivullemme <br> <br> <br>Kaikki ehdokkaat kohdasta l�yd�t kaikki ehdokkaat ja vastaa kysymyksiin kohdasta p��set vastailemaan kysymyksiin joiden avulla tied�mme kuka on juuri sinulle paras ehdokas. </p>
         </div>
        <div class="hull">
            <img src="./kuvat/voteCounts.png" style="margin-right:10%; float:right; width:20%; height:100%;">
            <p class="hullText" >Sivumme tarkoitus on kysyä sinulta kysymyksi� ehdokkaista ja niiden avulla n�ytt�� juuri sinulle parhaan ehdokkaan. </p>
         </div>
    </div>
